...
export class ApibieroService {
    ...
    /** PUT requête pour enregistrer l'usager */
    ...
    login(data: any): Observable<any>{
        return this.http.post<any>(this.url+'usager/login', data);
    }
    ...
    /** PUT requête pour ajouter la note de la bouteille */
    ajouterNoteBouteille(data: IProduit): Observable<any>{
        let httpOption = {
            headers : new HttpHeaders({
                'Content-type': 'application/json',
                'Authorization' : 'Basic '+ btoa("biero:biero")
        ...
        return this.http.put<IProduit>(this.url+'bouteille/note/', data, httpOption);
    }
    ...
    /** PUT requête pour ajouter la bouteille dans le vino__bouteille */
    ...
    /** PUT requête pour ajouter le cellier */
    ...
    /** GET requête pour afficher le cellier */
